...
public class AddBrand extends javax.swing.JFrame {
    ...
    public void setTable(){
        ...
        try {
            ...
            ResultSet rs = db.Getresultset("select * from `brand`");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 50, -1, -1));

        jLabel1.setText("Add Brand");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 170, -1));
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 170, -1));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 330, 90));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try{
           ...
           SQL = String.format("SELECT Brand_ID FROM brand WHERE Brand_ID = '%s' ;" , id );  
           ...
           B0 = RSS.next();    
            ...
            {                    
                JOptionPane.showMessageDialog(this,"ID already use");         
                        ...
                        SQL = String.format("INSERT INTO brand(Brand_ID,Brand_Name) VALUES('%s','%s')", id , name );
            ...
            try {
               ...
               System.out.println("CON0123.Execute   !!!!!!!!!!!!!!!!!!!");
           }
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String data = (String) model.getValueAt(selectedRowIndex, 0);
        System.out.println("data selectedRow = "+ data);
