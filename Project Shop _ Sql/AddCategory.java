...
public class AddCategory extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            SQL = String.format("SELECT Category_ID FROM category WHERE Category_ID = '%s' ;" , id );
        ...
        if(B0)
        {
            ...
            SQL = String.format("INSERT INTO category(Category_ID,Category_Name) VALUES('%s','%s')", id , name );
